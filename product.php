    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /.row 
                <button class="btn btn-primary" id="add-stock">Agregar inventario
                    <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
                </button>
-->
                <button class="btn btn-danger" id="del-stock">Borrar del inventario
...
<script type="text/javascript" src="assets/js/saludo.js"></script>
